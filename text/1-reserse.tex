...
tvaru a atributů geografic\-kých prvků \cite{shapefile}}, který obsahuje
vektorové geometrické data ve formě polygonových prvků. K této podobě bylo potřeba přistoupit
