...
kvůli jeho složitosti často nepoužívá. \cite{vanicek}
...
Na vstupu \textit{Voronoi diagramu} je nějaká množina bodů a výstupem je \textit{Voronoi diagram}, 
...
Pro lepší chápání \textit{Voronoi diagramů} je potřeba si vysvětlit jeji terminologii.
...
Prvním algoritmem je generalizační algoritmus \textit{Douglas-Peucker}. Algoritmus rekurzivně rozděluje čáru.
