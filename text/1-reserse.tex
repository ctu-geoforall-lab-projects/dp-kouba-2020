...
%% ML: nazev portalu by mel zacit velkym pismenem
na portálu \textit{opendata hlavního města Prahy} \cite{opendata}. Tento shapefile
%% ML: obsahuje tarifni pasma v podobe polygonovych prvku?
obsahuje vektorové vrstvy polygonů.
%% ML: zminte, ze jste tato data povazoval v praci jako referencni

\subsubsection{Triangulace}
\label{triangulace}

%% ML: "Prvni myslenkou, jak se priblizit" zkuste preformulovat
...
%% ML: obecne, pouzivate dlouha souveti. Zkuste rozdelit do vice vet.
...
%% ML: v predchozi kapitole pouzivate cesky termin (rozdel a panuj)
...
Nejpoužívanější teselací v oblastí GIS je Voronoi diagram, někdy nazývána Voroné\-ho teselace, Voroného dekompozice,
...
%% ML: Nezacinejte vetu "Takze" ci podobnym zpusobem
...
%% ML: "jisty vztah s" zni ponekud expresivne
...
%% ML: Obecne, dejte si pozor na opakovani slov v jedne vete. Zde je slovo "algoritmus" na jednom radku hned 3x
