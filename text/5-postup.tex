...
Z již zmiňované vektorové vrstvy stops (viz obr.4) vytvořím vektorovou vrstvu
pomocí Voroného diagramů. K jeho tvorbě využívám QGIS nástroj
Voroného polygony, jehož zdrojový kód je veřejně publikován na GitHubu.
Vstupem do tohoto nástroje je vektorová vrstva stops.
