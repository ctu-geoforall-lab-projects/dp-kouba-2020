...
a manuální zásah tvůrce je požadovaný téměř ke všemu.
Primární cílem této diplomové práce bylo za pomocí zastávek z GTFS datasetu, 
o kterém se mimo jiné píše v kapitole \ref{2-teorie-gtfs}, vytvořit postup 
pro automatické vyhotovení exaktního modelu tarifních pásem a co nejvíce se přiblížit k jejich
oficiální podobě vydávánou organizací ROPID. Oficiální podoba tarifních pásem je veřejně publikována
na portálu \textit{Opendata hlavního města Prahy}.
