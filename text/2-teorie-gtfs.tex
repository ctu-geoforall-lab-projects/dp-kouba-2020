...
General Transit Feed Specification, zkráceně \zk{GTFS}, je dokument, který definuje
...
\zk{CSV}, \textit{Comma-separated values}, v překladu \textit{hodnoty oddělené čárkami}, je jednoduchý 
