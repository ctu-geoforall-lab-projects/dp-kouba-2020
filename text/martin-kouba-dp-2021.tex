...
%% Abstrakt
%% ML: abstrakt by mel byt delsi (a hlavne popisny)
\abstrakt {Tato diplomová práce se zabývá vytvářením tarifních pásem pro dopravní systém Pražské integrované dopravy pomocí zásuvného modulu v softwaru QGIS na podkladu GTFS datasetu. Tento zásuvný modul byl vytvořen pomocí programovacího jazyka Python a PyQt vazbou pro vytváření grafického uživatelského rozhraní.}
	      {This diploma thesis focuses on creating of tarrif zones for public transport system of Prague Integrated Transport using a plugin in the QGIS software based on the GTFS dataset. This plugin was created using the Python programming language and PyQt binding for creating a graphical user interface.}
