...
%% Abstrakt
\abstrakt {Tato diplomová práce se zabývá automatizací vytváření tarifních pásem pro dopravní systém Pražské integrované dopravy. Implementace řešení je prováděna jako rozšíření již existujícího zásuvného modulu za pomocí GTFS datasetu. Automatizace by měla pomoct pracovníkům organizace ROPID s tvorbou tarifních pásem, která se provádí téměř celá manuálně. Rozšíření zásuvného modulu bylo vytvořeno pomocí programovacího jazyka Python v open source systému QGIS.}
	      {This diploma thesis deals with the automation of creating of tarrif zones for public transport system of Prague Integrated Transport. The implementation of the solution is performed as an extension of an existing plugin using the GTFS dataset. Automation should help ROPID staff with the creation of tarrif zones, which is done almost entirely manually. This plugin extension was created using the Python programming language in the open source QGIS system}
