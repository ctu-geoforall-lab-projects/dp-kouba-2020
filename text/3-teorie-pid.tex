...
%% ML: V uvodu uvadite, ze PID zasahuje do vice kraju...
...
%% ML: vynechte hodnoceni metod nebo nahradte za "pouziva jednoduche nastroje"
...
případně pro následné úpravy. \textit{"Když ručně vytvaruji všechny polygony tak, aby procházely 
  ...
  %% ML: nejaka forma automatizace tedy v aktualnim postupu je ...
...
%% ML: zvolte stejnou symbologii jako na obrazku 3.5
\begin{figure}[H] \centering
